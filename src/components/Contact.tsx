...
import { Mail, Phone, MapPin, Github, Linkedin, Send, Coffee } from "lucide-react";
...
const Contact = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      icon: Linkedin,
      label: "LinkedIn",
      href: "https://www.linkedin.com/in/shreya-chaturvedi-ba1280218",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await emailjs.send(
        "service_mogb9pl",      // e.g. service_xxxxxx
        "template_x0qwymk",     // e.g. template_yyyyyy
        formData,
        "my10t7CYV1aiRfHYo"       // e.g. XyZaBc123
      );
